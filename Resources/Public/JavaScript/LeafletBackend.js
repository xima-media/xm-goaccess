define(['jquery', 'TYPO3/CMS/Backend/Icons', 'TYPO3/CMS/Backend/FormEngine', 'TYPO3/CMS/BwGuild/leaflet-core-1.4.0'], function ($, Icons, FormEngine) {
    'use strict';
    ...
    LeafBE.addMapMarkup = function () {
        $('body').append(
            ...
            '<div class="btn-group"><a href="#" class="btn btn-icon btn-default" title="' + LeafBE.$labelClose + '" id="t3js-bwguild-close-map">' +
            LeafBE.$iconClose +
            '</a>' +
            '<a class="btn btn-default" href="#" title="Import marker position to form" id="t3js-bwguild-import-position">' +
            LeafBE.$labelImport +
            '</a></div>' +
            LeafBE.$labelTitle +
            '</div>' +
    ...
    LeafBE.createMap = function () {
        ...
        $('#t3js-bwguild-import-position').on('click', function () {
        ...
        $('#t3js-bwguild-close-map').on('click', function () {
            $('#t3js-location-map-wrap').removeClass('active');
        });
    };
