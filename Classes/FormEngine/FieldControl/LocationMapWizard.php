...
namespace Blueways\BwGuild\FormEngine\FieldControl;

/**
 * This file is part of the "bw_guild" Extension for TYPO3 CMS.
 *
...
class LocationMapWizard extends AbstractNode
{
    ...
    public function render(): array
    {
        ...
        $resultArray['title'] = $this->getLanguageService()->sL('LLL:EXT:bw_guild/Resources/Private/Language/locallang_db.xlf:address.locationMapWizard');
        $resultArray['linkAttributes']['class'] = 'locationMapWizard ';
        $resultArray['linkAttributes']['data-label-title'] = $this->getLanguageService()->sL('LLL:EXT:bw_guild/Resources/Private/Language/locallang_db.xlf:address.locationMapWizard');
        $resultArray['linkAttributes']['data-label-close'] = $this->getLanguageService()->sL('LLL:EXT:bw_guild/Resources/Private/Language/locallang_db.xlf:address.locationMapWizard.close');
        $resultArray['linkAttributes']['data-label-import'] = $this->getLanguageService()->sL('LLL:EXT:bw_guild/Resources/Private/Language/locallang_db.xlf:address.locationMapWizard.import');
        ...
        $resultArray['stylesheetFiles'][] = 'EXT:bw_guild/Resources/Public/Contrib/leaflet-core-1.4.0.css';
        $resultArray['stylesheetFiles'][] = 'EXT:bw_guild/Resources/Public/Backend/LocationMapWizard/leafletBackend.css';
        $resultArray['requireJsModules'][] = 'TYPO3/CMS/BwGuild/leaflet-core-1.4.0';
        $resultArray['requireJsModules'][] = 'TYPO3/CMS/BwGuild/LeafletBackend';
